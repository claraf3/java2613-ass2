...
public class BookOptions {
	...
	/*
	 * This takes the arg you enter (-c -d) and process it to relevant enum(output)
	 */
	 ...
	 */
	/*
	 * use these to decide what report to generate. i.e. if isCustomersOptionSet() returns true,
	 * generate customers report.
	 * these methods are called in driver class (Bookstore.java)
	 */
	...
	public enum Value {
		/*
		 * the enums get updated (i.e. false becomes true) based on your arg input in run configurations
		 */
